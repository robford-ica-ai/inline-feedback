...
def test_debbie_api_client_structure():
    ...
    with open('src/debbie-integration/debbie-api-client.js', 'r') as f:
        content = f.read()
...
def test_owl2dict_converter_structure():
    ...
    with open('src/debbie-integration/owl2dict-converter.js', 'r') as f:
        content = f.read()
    ...
    assert 'https://raw.githubusercontent.com/ProjectDebbie/Ontology_DEB/master/DEB_ont.owl' in content
...
def test_gold_standard_pmid_loader_structure():
    ...
    with open('src/debbie-integration/gold-standard-pmid-loader.js', 'r') as f:
        content = f.read()
...
def test_gold_standard_pmid_files():
    ...
    assert 'https://raw.githubusercontent.com/ProjectDebbie/gold_standard_set' in content
...
def test_project_debbie_coordinator_structure():
    ...
    with open('src/debbie-integration/project-debbie-coordinator.js', 'r') as f:
        content = f.read()
...
def test_ontology_categorization():
    ...
    categories = ['biomaterial', 'device', 'process', 'property', 'effect', 'application']
...
def test_global_instances():
    ...
    for file_path, global_name in zip(integration_files, expected_globals):
        with open(file_path, 'r') as f:
            content = f.read()
